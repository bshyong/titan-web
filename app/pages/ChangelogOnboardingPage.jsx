...
export default class ChangelogOnboardingPage extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <Slide title="Create a new changelog" next="Write your first posts" active={slide === 0} onNext={this.goToSlide(1)}>
          <ChangelogCreation />
        </Slide>
        <Slide title="Fill out your new changelog" next="Ok, gottit!" active={slide === 1} onNext={this.goToSlide(2)}>
